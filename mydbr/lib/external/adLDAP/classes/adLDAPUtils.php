...
class adLDAPUtils {
    ...
    */
	...
	/**
	* Avoid anonymous function in ldapSlashes. Compatibility with PHP 5.1/5.2
	*
	* @param array $matches escape matches
	* @author myDBR.com
	* @return string
	*/
    private function ldapSlashes_callback($matches)
    {
