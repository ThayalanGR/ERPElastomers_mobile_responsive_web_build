...
$$
INSERT INTO demo_oem_cluster VALUES (26, 'Samsung', 'Android', 2016)
$$
INSERT INTO demo_oem_cluster VALUES (27, 'Huawei', 'Android', 2016)
$$
INSERT INTO demo_oem_cluster VALUES (28, 'Oppo', 'Android', 2016)
$$
INSERT INTO demo_oem_cluster VALUES (29, 'Xiaomi', 'Android', 2016)
$$
INSERT INTO demo_oem_cluster VALUES (30, 'VIVO', 'Android', 2016)
$$
...
$$
insert into demo_platform values (9, 'iOS')
$$
...
$$
INSERT INTO demo_oem_platform VALUES ('Apple', 'iOS', 2008)
$$
INSERT INTO demo_oem_platform VALUES ('Apple', 'iOS', 2011)
$$
...
$$
INSERT INTO demo_oem_platform VALUES ('Samsung', 'Android', 2016)
$$
INSERT INTO demo_oem_platform VALUES ('Huawei', 'Android', 2016)
$$
INSERT INTO demo_oem_platform VALUES ('Oppo', 'Android', 2016)
$$
INSERT INTO demo_oem_platform VALUES ('Xiaomi', 'Android', 2016)
$$
INSERT INTO demo_oem_platform VALUES ('VIVO', 'Android', 2016)
$$
INSERT INTO demo_oem_platform VALUES ('Apple', 'iOS', 2016)
$$
...
SELECT CONCAT(vFont, 'shape=box,fillcolor=green,style=filled,fontcolor=white') into vUI;
SELECT CONCAT(vFont, 'shape=box,fillcolor=red,style="rounded,filled"') into vOEM;
SELECT CONCAT(vFont, 'fontcolor=black,style=filled,fillcolor=#EFEFEF') into vCluster;
...
where name in (
  select pt.tech
  from demo_platform_tech pt
    join demo_oem_platform op on op.platform = pt.platform
  where op.year = inYear
);
...
SELECT 'dbr.googlemaps', 'address', 'French sightseeing', 700, 700;

/* select the search address an the Google Maps bubble text */

SELECT 'la Tour Eiffel', 'la Tour Eiffel'
UNION
SELECT "Tour Montparnasse", 'Tour Montparnasse';
...
UNION
SELECT 'Tour Montparnasse', 'Tour Montparnasse', 'http://maps.google.com/mapfiles/kml/shapes/ranger_station.png::64::64';
...
CALL sp_MyDBR_ParamQueryAdd('demo_scenario', 'select 2008, 2008 union select 2011, 2011 union select 2016, 2016', 0, null);
