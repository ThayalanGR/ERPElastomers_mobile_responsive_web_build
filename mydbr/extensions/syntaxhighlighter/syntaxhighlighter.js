 ...
 * 
 * @version
 * 4.0.1 (Mon, 18 Sep 2017 08:12:31 GMT)
 * 
 * @copyright
...
/***/ (function(module, exports) {
	...
	Renderer.prototype = {
	  ...
	  getHtml: function getHtml() {
	    ...
	    html = '<div class="' + classes.join(' ') + '"><table border="0" cellpadding="0" cellspacing="0">\n          ' + _this.getTitleHtml(opts.title) + '\n          <tbody>\n            <tr>\n              ' + (gutter ? '<td class="gutter">' + _this.renderLineNumbers(code) + '</td>' : '') + '\n              <td class="code"><div class="container">' + html + '</div></td>\n            </tr>\n          </tbody>\n        </table></div>\n    ';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Brush() {
	  ...
	  this.regexList = [{
	    ...
	    regex: /\/\*([^\*][\s\S]*?)?\*\//gm,
	    css: 'comments'
	  }, { regex: /[\'\"]dbr\.[a-z_.]*[\'\"]/g, css: 'mydbr_cmd' }, {
