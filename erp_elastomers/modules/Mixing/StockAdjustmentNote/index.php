...
<div id="window_list_wrapper">
    <div id="window_list_head">
        <strong>Mixing - Stock Adjustment Note</strong>
    ...
    <div id="content_head" style="padding-bottom:0px;">
        <table border="0" cellpadding="6" cellspacing="0" width="100%">
            <tr>
                ...
                <th width="15%" align="left" title="Base Polymer">CPD Polymer</th>
                <th width="20%" align="left" title="Compound Name">CPD Name</th>
    ...
    <div id="new_san_dialog">
        ...
        <form action="" onsubmit="return false;">
            <table border="0" cellspacing="0" cellpadding="5" style="width:100%">
                <tr>
                    <td width="20%">Compound</th>
                    <td><input type="text" style="width:50%" class="cpd_auto_list" /></th>
    ...
    <div id="view_san_dialog">
    	<div class="supplier_list_head" style="margin-top:10px;">
        	<table border="0" cellspacing="0" cellpadding="5">
            	<tr>
                	<th align="left" width="20%">BAT Ref</th>
                	<th align="left" width="20%">BAT Date</th>
