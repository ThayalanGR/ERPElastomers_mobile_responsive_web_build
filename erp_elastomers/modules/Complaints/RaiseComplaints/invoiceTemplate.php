<?php
	...
	$inv_comp		=	@getMySQLData("select DATE_FORMAT(complaintDate, '%d-%m-%Y') as complaintDate,tcmpd.cmpdname,tcmpd.cmpdrefno,class,description,tcust.cusName,tcomp.status,DATE_FORMAT(tcomp.entry_on, '%d-%m-%Y') as entry_on,tuent.fullName as entry_by,mode,
										...
										DATE_FORMAT(closure_target, '%d-%m-%Y') as closure_target,DATE_FORMAT(closure_on, '%d-%m-%Y') as closure_on,tucl.fullName as closure_by,cusConfRemarks,DATE_FORMAT(cusConfDate, '%d-%m-%Y') as cusConfDate,
	...
	<p align="right">Form No:
    	...
    	<table cellpadding="3" cellspacing="0" border="0" id="print_out" >
		   ...
		   <tr>
				...
				<td>
					: <?php print $particulars['mode']; ?>
				</td>
			</tr>
			<tr>
				<td  class="content_bold" style="border-right:0px;width:15%;">
					Part Number
				</td>
				<td style="width:18%;">
					: <?php print ($particulars['cmpdname'])?$particulars['cmpdname']:'-'; ?>
				</td>
				<td class="content_bold" style="border-right:0px;width:15%;">
					Part Desc.
				</td>
				<td style="width:18%;">
					: <?php print ($particulars['cmpdrefno'])?$particulars['cmpdrefno']:'-'; ?>
				</td>
				<td class="content_bold" style="border-right:0px;width:15%;">
					Classification 
				</td>
				<td>
					: <?php print $particulars['class']; ?>
				</td>
			</tr>
			<tr>
				<td  class="content_bold" style="border-right:0px;">
				...
				<td>
					: <?php print $particulars['nature']; ?>
				</td>
				<td class="content_bold" style="border-right:0px;">
					Cust. Ref.
				</td>
				<td>
					: <?php print ($particulars['compCusRef'])?$particulars['compCusRef']:'-'; ?>
				</td>
				<td class="content_bold" style="border-right:0px;">
					Cust. Date 
				</td>
				<td>
					: <?php print ($particulars['compCusRefDate'] != '00-00-0000')?$particulars['compCusRefDate']:'-'; ?>
				</td>
			</tr>
			<?php if($particulars['retQty'] > 0) {?>
			<tr>
				<td  class="content_bold" style="border-right:0px;">
					Return Qty.
				</td>
				<td>
					: <?php print $particulars['retQty']; ?>
				</td>
				<td class="content_bold" style="border-right:0px;">
					Return Docref.
				</td>
				<td>
					: <?php print $particulars['retDocRef']; ?>
				</td>
				<td class="content_bold" style="border-right:0px;">
					Return Date
				</td>
				<td>
					: <?php print $particulars['retDate']; ?>
				</td>
			</tr>
			<?php } ?>
			<tr>
			...
			<tr style="height:120px;vertical-align:top;">
				<td colspan="6">
					<?php print $particulars['cusConfRemarks']; ?>
				</td>
			</tr>
			<tr>
				<td class="content_bold" style="border-right:0px;">Confirmed On</td>
				<td colspan="2">:<?php print ($particulars['cusConfDate'] != '00-00-0000')?$particulars['cusConfDate']:'&nbsp;'; ?></td>
				<td colspan="3">&nbsp;</td>
			</tr>	
			<tr>
				<td colspan="6" class="content_bold">
