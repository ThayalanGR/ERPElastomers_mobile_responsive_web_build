<div id="window_list_wrapper" class="filter-table">
	...
	<br />
	<div id="window_list_head">
		<strong>Incoming Compound Approval List</strong>
		<div style="float:right;" >
			<strong>Show Approval Report for : </strong>
			<select id="batidlist" >
			</select>
...
<div style="display:none">    
	<div id="print_item_form" title="Incoming Compound Test" style="visibility:hidden">
		<p align="right">Form No:
			<?php 
				$formArray		=	@getFormDetails(33);
				print $formArray[0]; 
			?>
		</p>	
